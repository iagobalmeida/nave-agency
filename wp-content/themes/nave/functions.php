...
function twentytwenty_register_styles() {
	...
	// Nave CSS
	wp_enqueue_style( 'nave-style', get_template_directory_uri() . '/assets/css/main.css', null, $theme_version, 'all' );
	
	// Nave Fonts
	wp_enqueue_style( 'nave-font', 'https://fonts.googleapis.com/css2?family=Be+Vietnam+Pro:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=IBM+Plex+Sans+Thai+Looped:wght@100;200;300;400;500;600;700&display=swap', null, $theme_version, 'nave-fonts' );
...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script( 'nave-index-js', get_template_directory_uri() . '/assets/js/nave-index.js', array(), $theme_version, false );
